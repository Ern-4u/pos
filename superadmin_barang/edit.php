...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $ambil_data_lama = mysqli_query($conn, "SELECT * FROM barang WHERE kode_barang ='$get_kode_barang'")or die(mysqli_error($conn));
        ...
        <div class="card">
              ...
              <form action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text"  value="<?= $result['kode_barang']?>" name="kode_barang" class="form-control" id="kode_barang" maxlength="10" placeholder="Masukan Kode Barang" required readonly>
                </div>
                <div class="form-group">
                    <label for="nama_barang">Nama Barang</label>
                    <input type="text" name="nama_barang" value="<?= $result['nama_barang']?>" class="form-control" id="nama_barang" maxlength="20" placeholder="Masukan Nama Barang " required>
                </div>
                <div class="form-group">
                    <label for="merk">Merk</label>
                    <input type="text" name="merk" value="<?= $result['merk']?>" class="form-control" id="merk" maxlength="15" placeholder="Masukan Merk Barang" required>
                </div>
                <div class="form-group">
                    <label for="stok">Stok</label>
                    <input type="number" name="stok" value="<?= $result['stok']?>" class="form-control" id="stok" placeholder="Masukan Stok Barang" required>
                </div>
                <div class="form-group">
                    <label for="rata_harga_beli">Harga Beli</label>
                    <input type="number" name="rata_harga_beli" value="<?= $result['rata_harga_beli']?>" class="form-control" id="rata_harga_beli" placeholder="Masukan Harga Beli Barang" required>
                </div>
                <div class="form-group">
                    <label for="harga_jual">Harga Jual</label>
                    <input type="number" name="harga_jual" value="<?= $result['harga_jual']?>" class="form-control" id="harga_jual" placeholder="Masukan Harga Jual Barang" required>
                </div>
...
if (isset($_POST['btn_edit'])) {
    ...
    $harga_jual = trim(mysqli_real_escape_string($conn, $_POST['harga_jual']));
            ...
            $query_simpan = mysqli_query($conn, "UPDATE barang
            ...
            window.location.href="../superadmin_barang/edit.php" </script>';
