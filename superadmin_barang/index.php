...
<head>
  ...
  $query = "SELECT barang.*, suplier.nama_suplier 
            FROM barang 
            LEFT JOIN suplier ON barang.kode_suplier = suplier.kode_suplier";
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  foreach ($data_barang as $s) : ?>
                    <tr>
                      ...
                      <td><?= $s['merk'] ?> </td>
                      <td><?= $s['stok'] ?> </td>
                      <td><?= $s['rata_harga_beli'] ?> </td>
                      <td><?= $s['harga_jual'] ?> </td>
                      <td><?= $s['nama_suplier'] ?> </td>
                      <td>
                          <svg class="barcode"
                              data-kode="<?= htmlspecialchars($s['kode_barang']) ?>">
                          </svg>
                        </td>
                      <td>
                      <?php
                      if ($s['foto_barang'] == null) {    ?>
                            ...
                            <button type="button"  data-toggle="modal" data-target="#modal-foto" data-kode_barang="<?= $s['kode_barang'] ?>">
                            <img src='../assets/foto_barang/fto_barang.png' class='img-fluid' width='50px' height='50px'>
                            </button>
                            <?php
                      } else { ?>
                            <button type="button"  data-toggle="modal" data-target="#modal-foto" data-nim="<?= $s['kode_barang'] ?>">
                      ...
                      <td>
                        <a href="hapus.php?kode_barang=<?= $s['kode_barang']; ?>" 
                        class="btn btn-danger btn-xs" onclick="return confirm('YAKIN LU?')">
                        <i class="fas fa-trash"></i></a>
                        <a href="edit.php?kode_barang=<?= $s['kode_barang'] ?>" class="btn btn-warning btn-xs">
