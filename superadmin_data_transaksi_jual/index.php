  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Transaksi Jual</h1>
          </div>
        </div>
      </div>
    </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    if (isset($_GET['tgl_mulai']) && isset($_GET['tgl_selesai']) && $_GET['tgl_mulai'] != '' && $_GET['tgl_selesai'] != '') {
                      ...
                      $where = " WHERE tgl_penjualan BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
                    }

                    $query = "SELECT * FROM nota_jual $where ORDER BY tgl_penjualan DESC, kode_nota DESC";
