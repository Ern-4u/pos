<html>
    ...
    <body>
        ...
        $hapus_nota_jual = mysqli_query($conn, "DELETE FROM nota_jual 
        WHERE kode_nota = '$kode_nota'")or die (mysqli_error($conn)); 
        
        $cek_detail_nota = mysqli_query($conn, "SELECT * FROM detail_nota_jual WHERE kode_nota = '$kode_nota'") or die(mysqli_error($conn));
